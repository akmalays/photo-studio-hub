  ...
  return (
    <section id="tentang" className="px-4 py-16 sm:px-8 md:py-24 md:px-16 lg:px-24">
      <div className="grid items-center gap-10 md:gap-16 lg:grid-cols-2">
        ...
        <div>
          <p className="mb-3 font-body text-sm uppercase tracking-[0.3em] text-primary">Tentang Saya</p>
          ...
          <p className="mb-4 font-body text-base leading-relaxed text-muted-foreground sm:mb-6 sm:text-lg">
            Saya adalah fotografer profesional dengan passion mendalam dalam menangkap momen-momen yang bermakna. Dengan lebih dari satu dekade pengalaman, saya telah bekerja
            dengan berbagai klien — dari pernikahan intimate hingga brand internasional.
          </p>
